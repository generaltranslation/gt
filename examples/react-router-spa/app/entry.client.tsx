...
// BEFORE the router renders, so that <T>, useLocale, and any t() call resolve
// against loaded translations. We await initializeGTSPA(), then dynamically
// import the module that hydrates the router. The dynamic import is what
// guarantees the app's module graph (and any module-level t()) is not
// evaluated until initialization has finished.
async function main() {
