...
import { createGtFunction } from './gt';
import { I18nManager } from '../../i18n-manager/I18nManager';

/**
 * Factory for the m function.
 * @param gtFunction - The gt function to use.
 * @returns The m function.
 */
export function createMFunction(i18nManager: I18nManager) {
  const gt = createGtFunction(i18nManager);
  /**
   ...
   */
  const m: InteralMFunctionType = async (
    encodedMsg: string,
