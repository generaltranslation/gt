...
Object.defineProperty(exports, 'BaseCLI', {
  enumerable: true,
  get: function () {
    return gt_react_cli_1.BaseCLI;
  },
});
const nextScanForContent_1 = __importDefault(
  require('./next/nextScanForContent')
);
const createDictionaryUpdates_1 = __importDefault(
  require('gt-react-cli/updates/createDictionaryUpdates')
);
const createInlineUpdates_1 = __importDefault(
  require('gt-react-cli/updates/createInlineUpdates')
);
