      ...
      __awaiter(void 0, void 0, void 0, function* () {
        try {
          const response = yield fetch(
            `${baseUrl}/v1/project/translations/status/${encodeURIComponent(versionId)}`,
            {
              method: 'GET',
              ...
              const newSuffixText = [
                `\n\n` +
                  chalk_1.default.green(
                    `${availableLocales.length}/${locales.length}`
                  ) +
                  ` translations completed`,
                ...availableLocales.map((locale) => {
                  const localeProperties = (0,
                  generaltranslation_1.getLocaleProperties)(locale);
        ...
        () =>
          __awaiter(void 0, void 0, void 0, function* () {
            ...
            if (isDeployed || elapsed >= timeoutDuration) {
              ...
              if (isDeployed) {
                spinner.succeed(
                  chalk_1.default.green('All translations are live!')
                );
              } else {
                spinner.fail(
                  chalk_1.default.red('Timed out waiting for translations')
                );
              }
              return;
            }
