...
function scanForContent(options, framework) {
  return __awaiter(this, void 0, void 0, function* () {
    ...
    const files = srcDirectory.flatMap((dir) =>
      (0, findJsxFilepath_1.getFiles)(dir)
    );
    const filesUpdated = [];
    for (const file of files) {
      const code = fs_1.default.readFileSync(file, 'utf8');
      // Create relative path from src directory and remove extension
      const relativePath = (0, findFilepath_1.getRelativePath)(
        file,
        srcDirectory[0]
      );
      let ast;
      ...
      let modified = false;
      let usedImports = [];
      let { importAlias, initialImports } = (0, parseAst_1.generateImportMap)(
        ast,
        framework
      );
      ...
      (0, traverse_1.default)(ast, {
        JSXElement(path) {
          ...
          const opts = Object.assign(Object.assign({}, importAlias), {
          ...
          const wrapped = (0, wrapJsx_1.handleJsxElement)(
            path.node,
            opts,
            evaluateJsx_1.isMeaningful
          );
      ...
      try {
        const output = (0, generator_1.default)(
          ast,
          {
            retainLines: true,
