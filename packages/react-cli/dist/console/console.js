...
exports.displayLoadingAnimation =
  exports.displayUpdatedConfigFile =
  exports.displayFoundTMessage =
  exports.displayResolvedPaths =
  exports.displayProjectId =
  exports.displayInitializingText =
  exports.displayAsciiTitle =
    void 0;
const chalk_1 = __importDefault(require('chalk'));
const displayAsciiTitle = () =>
  console.log(
    '\n\n' +
...
const displayProjectId = (projectId) => {
  console.log(
    chalk_1.default.yellow(`Project ID: ${chalk_1.default.bold(projectId)}`)
  );
};
  ...
  console.log(
    resolvedPaths
      .map(([key, resolvedPath]) =>
        chalk_1.default.gray(
          `'${chalk_1.default.white(key)}' -> '${chalk_1.default.green(resolvedPath)}'`
        )
      )
      .join('\n')
  );
...
const displayFoundTMessage = (file, id) => {
  console.log(
    `Found ${chalk_1.default.cyan('<T>')} component in ${chalk_1.default.green(file)} with id "${chalk_1.default.yellow(id)}"`
  );
};
