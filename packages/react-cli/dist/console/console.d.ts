...
export declare const displayCreatingNewConfigFile: (configFilepath: string) => void;
export declare const displayLoadingAnimation: (message: string) => NodeJS.Timeout;
