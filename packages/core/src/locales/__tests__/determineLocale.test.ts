...
describe('_determineLocale', () => {
  ...
  it('should work with custom mapping for locales', () => {
    ...
    expect(_determineLocale(locales, approvedLocales, customMapping)).toBe('custom-locale');
  });
  ...
  it('should work with custom mapping for approved locales', () => {
    ...
    expect(_determineLocale(locales, approvedLocales, customMapping)).toBeUndefined();
  });
