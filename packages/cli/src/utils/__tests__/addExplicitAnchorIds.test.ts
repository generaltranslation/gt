...
`;
    ...
    expect(result.content).toContain('<div id="no-links-here">\n\n## No Links Here\n\n</div>');
    expect(result.content).toContain('<div id="another-section">\n\n## Another Section\n\n</div>');
  });
...
`;
    ...
    expect(result.content).toContain('<div id="implementation-details">\n\n## Implementation Details\n\n</div>');
  });
...
`;
    ...
    expect(result.content).toContain('<div id="some-section">\n\n## Some Section\n\n</div>');
  });
...
`;
    ...
    expect(result.content).toContain('<div id="section">\n\n## Section\n\n</div>');
  });
