...
- 4cc8cd6: Align CLI automatic JSX insertion with compiler expression handling, component ownership, lexical bindings, and React runtime calls while preserving the original TypeScript source.
