...
function getGT(id) {
  return __awaiter(this, void 0, void 0, function () {
    var getId,
      ...
      translationsPromise,
      additionalMetadata_1,
      dictionarySubset,
      flattenedDictionaryEntries,
      translations_1;
    var _this = this;
    return __generator(this, function (_a) {
      switch (_a.label) {
        ...
        case 2:
          ...
          flattenedDictionaryEntries = (0, internal_1.flattenDictionary)(
            dictionarySubset
          );
        ...
        case 3:
          ...
          return [
            ...
            Promise.all(
              Object.entries(
                flattenedDictionaryEntries !== null &&
                  flattenedDictionaryEntries !== void 0
                  ? flattenedDictionaryEntries
                  : {}
              ).map(function (_a) {
                  ...
                  return __generator(this, function (_f) {
                    switch (_f.label) {
                      case 0:
                        ...
                        // only tx strings
                        if (typeof entry !== 'string') return [2 /*return*/];
                        entryId = getId(suffix);
                        // Skip empty strings
                        if (!entry.length) {
                          console.warn(
                            'gt-next warn: Empty string found in dictionary with id: '.concat(
                              entryId
                            )
                          );
                          return [2 /*return*/];
                        ...
                        if (!runtimeTranslationEnabled) return [2 /*return*/];
                      ...
                      case 3:
                        ...
                        console.error(
                          (0,
                          createErrors_1.createDictionaryStringTranslationError)(
                            entryId
                          ),
                          error_1
                        );
        ...
        case 5:
          return [
            ...
            function (id, options) {
              ...
              var _a = (0, internal_1.extractEntryMetadata)(dictionaryEntry),
                entry = _a.entry,
              ...
              if (typeof entry === 'string') {
                var contentArray =
                  ...
                  (0, generaltranslation_1.splitStringToContent)(entry);
              ...
              if ((0, internal_1.isEmptyReactFragment)(entry)) {
                console.warn(
                  'gt-next warn: Empty fragment found in dictionary with id: '.concat(
                    id
                  )
                );
                return entry;
