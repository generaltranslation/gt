...
function T(_a) {
  return __awaiter(this, arguments, void 0, function (_b) {
    ...
    var children = _b.children,
      ...
      variablesOptions = _b.variablesOptions;
      ...
      switch (_j.label) {
        case 0:
          ...
          if ((0, internal_1.isEmptyReactFragment)(children))
            return [
              2 /*return*/,
              (0, jsx_runtime_1.jsx)(react_2.default.Fragment, {}),
            ];
        ...
        case 1:
          ...
          (_c = I18NConfig.serializeAndHashChildren(taggedChildren, context)),
            (childrenAsObjects = _c[0]),
            (hash = _c[1]);
        ...
        case 4:
          ...
          if (
            (translationEntry === null || translationEntry === void 0
              ? void 0
              : translationEntry.state) === 'success'
          ) {
            return [
              2 /*return*/,
              (0, internal_1.renderTranslatedChildren)({
          ...
          _g = [
            __assign(
              __assign(__assign({}, id && { id: id }), { hash: hash }),
              context && { context: context }
            ),
          ];
          return [4 /*yield*/, (0, getMetadata_1.default)()];
        case 5:
          translationPromise = _f
            .apply(_e, [
              ((_h.metadata = __assign.apply(void 0, [
          ...
          return [
            ...
            (0, jsx_runtime_1.jsx)(
              react_1.Suspense,
              {
                ...
                children: (0, jsx_runtime_1.jsx)(Resolver, {
                  children: translationPromise,
                }),
              },
              locale
            ),
