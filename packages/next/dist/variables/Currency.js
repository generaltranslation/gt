...
function Currency(_a) {
  var children = _a.children,
    ...
    value = _a.value,
    _b = _a.currency,
    currency = _b === void 0 ? 'USD' : _b,
    _c = _a.options,
    options = _c === void 0 ? {} : _c,
    _d = _a.locales,
    locales =
      _d === void 0 ? [(0, getI18NConfig_1.default)().getDefaultLocale()] : _d,
    props = __rest(_a, [
      'children',
      'name',
      'value',
  ...
  return (0, jsx_runtime_1.jsx)('span', {
    ...
    'data-_gt-variable-options': JSON.stringify(
      __assign({ style: 'currency', currency: currency }, options)
    ),
    ...
    children: typeof formattedValue === 'string' ? formattedValue : undefined,
  });
}
