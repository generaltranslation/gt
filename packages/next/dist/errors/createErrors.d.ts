...
export declare const dictionaryDisabledError = "gt-next: Error You are trying to use a dictionary, but you have not added the initGT() plugin to your app. You must add initGT() to use dictionaries. For more information, visit generaltranslation.com/docs";
...
export declare const usingDefaultsWarning = "gt-next: Warn Unable to access gt-next configuration. Using defaults.";
...
export declare const projectIdMissingWarn = "gt-next: Warn Project ID missing! Set projectId as GT_PROJECT_ID in your environment or by passing the projectId parameter to initGT(). Find your project ID: generaltranslation.com/dashboard.";
