...
exports.projectIdMissingWarn =
  exports.createMismatchingHashWarning =
  exports.createUnsupportedLocalesWarning =
  exports.createNoEntryWarning =
  exports.usingDefaultsWarning =
  exports.createDictionarySubsetError =
  exports.devApiKeyIncludedInProductionError =
  exports.createRequiredPrefixError =
  exports.createDictionaryStringTranslationError =
  exports.createStringTranslationError =
  exports.remoteTranslationsError =
  exports.APIKeyMissingError =
    void 0;
...
var createStringTranslationError = function (content, id) {
  return 'gt-next string translation error. tx("'
    .concat(content, '")')
    .concat(id ? ' with id "'.concat(id, '"') : '', ' failed.');
};
exports.createStringTranslationError = createStringTranslationError;
var createDictionaryStringTranslationError = function (id) {
  return 'gt-next string translation error. Translation from dictionary with id: '.concat(
    id,
    ' failed.'
  );
};
...
var createRequiredPrefixError = function (id, requiredPrefix) {
  return 'You are using <GTProvider> with a provided prefix id: "'
    .concat(
      requiredPrefix,
      '", but one of the children of <GTProvider> has the id "'
    )
    .concat(
      id,
      '". Change the <GTProvider> id prop or your dictionary structure to proceed.'
    );
};
...
var createDictionarySubsetError = function (id, functionName) {
  return 'General Translation: '
    .concat(functionName, ' with id: "')
    .concat(
      id,
      '". Invalid dictionary entry detected. Make sure you are navigating to the correct subroute of the dictionary with the ID you provide.'
    );
};
...
var createUnsupportedLocalesWarning = function (locales) {
  return 'General Translation: The following locales are currently unsupported by our service: '.concat(
    locales
      .map(function (locale) {
...
var createMismatchingHashWarning = function (expectedHash, receivedHash) {
  return 'gt-next: Mismatching hashes! Expected hash: '
    .concat(expectedHash, ', but got hash: ')
    .concat(
      receivedHash,
