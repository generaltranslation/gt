 ...
 *
 */
export declare function initGT({ config, i18n, dictionary, devApiKey, runtimeTranslation, remoteCache, apiKey, projectId, runtimeUrl, cacheUrl, cacheExpiryTime, locales, defaultLocale, renderSettings, maxConcurrentRequests, maxBatchSize, batchInterval, ...metadata }?: InitGTProps): (nextConfig?: any) => any;
