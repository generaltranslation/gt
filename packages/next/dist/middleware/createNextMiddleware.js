...
function createNextMiddleware(_a) {
  var _b =
      _a === void 0
        ...
        : _a,
    _c = _b.localeRouting,
    localeRouting = _c === void 0 ? true : _c,
    _d = _b.prefixDefaultLocale,
    prefixDefaultLocale = _d === void 0 ? false : _d;
  var envParams;
  ...
  var defaultLocale =
    (envParams === null || envParams === void 0
      ? void 0
      : envParams.defaultLocale) || internal_1.libraryDefaultLocale;
  var locales =
    (envParams === null || envParams === void 0 ? void 0 : envParams.locales) ||
    (0, supported_locales_1.listSupportedLocales)();
  if (!(0, generaltranslation_1.isValidLocale)(defaultLocale))
    throw new Error(
      'gt-next middleware: defaultLocale "'.concat(
        defaultLocale,
        '" is not a valid locale.'
      )
    );
  var warningLocales = locales.filter(function (locale) {
    return !(0, generaltranslation_1.isValidLocale)(locale);
  });
  if (warningLocales.length)
    console.warn(
      (0, createErrors_1.createUnsupportedLocalesWarning)(warningLocales)
    );
  ...
  function nextMiddleware(req) {
    ...
    if (localeRouting) {
      ...
      var extractedLocale = (0, generaltranslation_1.standardizeLocale)(
    ...
    if (
      (0, generaltranslation_1.isValidLocale)(
        cookieLocale === null || cookieLocale === void 0
          ? void 0
          : cookieLocale.value
      )
    ) {
      ...
      if (
        resetCookie === null || resetCookie === void 0
          ? void 0
          : resetCookie.value
      ) {
    ...
    if (localeRouting) {
      ...
      if (referer && typeof referer === 'string') {
        var refererLocale = extractLocale(
          (_a = new URL(referer)) === null || _a === void 0
            ? void 0
            : _a.pathname
        );
    ...
    var acceptedLocales =
      ((_b = headerList.get('accept-language')) === null || _b === void 0
        ? void 0
        : _b.split(',').map(function (item) {
            var _a;
            return (_a = item.split(';')) === null || _a === void 0
              ? void 0
              : _a[0].trim();
          })) || [];
    ...
    var userLocale = (0, generaltranslation_1.standardizeLocale)(
      (0, generaltranslation_1.determineLocale)(
        candidates.filter(generaltranslation_1.isValidLocale),
        approvedLocales
      ) || defaultLocale
    );
