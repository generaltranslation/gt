...
var ClientProviderWrapper_1 = __importDefault(
  require('./ClientProviderWrapper')
);
/**
...
function GTProvider(_a) {
  return __awaiter(this, arguments, void 0, function (_b) {
    var getId,
      ...
      clientRuntimeTranslationEnabled,
      translationsPromise,
      dictionarySubset,
      flattenedDictionarySubset,
      translations,
      _c,
      dictionary,
      promises;
    ...
    return __generator(this, function (_d) {
      switch (_d.label) {
        ...
        case 2:
          ...
          dialectTranslationRequired =
            translationRequired &&
            (0, generaltranslation_1.isSameLanguage)(locale, defaultLocale);
          clientRuntimeTranslationEnabled =
            I18NConfig.isClientRuntimeTranslationEnabled();
          translationsPromise =
          ...
          if (
            typeof dictionarySubset !== 'object' ||
            Array.isArray(dictionarySubset)
          )
            // cannot be a DictionaryEntry, must be a Dictionary
            throw new Error(
              (0, createErrors_1.createDictionarySubsetError)(
                id !== null && id !== void 0 ? id : '',
                '<GTProvider>'
              )
            );
          flattenedDictionarySubset = (0, internal_1.flattenDictionary)(
            dictionarySubset
          );
        ...
        case 5:
          ...
          return [
            ...
            Promise.all(
              Object.entries(
                flattenedDictionarySubset !== null &&
                  flattenedDictionarySubset !== void 0
                  ? flattenedDictionarySubset
                  : {}
              ).map(function (_a) {
                  ...
                  return __generator(this, function (_e) {
                    switch (_e.label) {
                      case 0:
                        ...
                        (_c = (0, internal_1.extractEntryMetadata)(
                          dictionaryEntry
                        )),
                          (entry = _c.entry),
                        ...
                        if (typeof entry !== 'string') {
                          ...
                          (_d = I18NConfig.serializeAndHashChildren(
                            taggedChildren,
                            metadata === null || metadata === void 0
                              ? void 0
                              : metadata.context
                          )),
                            (childrenAsObjects = _d[0]),
                            (hash_1 = _d[1]);
                          dictionary[entryId] = [
                            taggedChildren,
                          ...
                          // skip if:
                          if (
                            translationEntry_1 && // already have translation
                          ...
                          if ((0, internal_1.isEmptyReactFragment)(entry)) {
                            translations[key_1] = {
                              state: 'error',
                              error:
                                'Empty fragments are not allowed for translation.',
                              code: 400,
                            };
                            return [2 /*return*/];
                          }
                          ...
                          translationPromise = I18NConfig.translateChildren({
                            ...
                            .catch(function (error) {
                              if (
                                error instanceof internal_1.GTTranslationError
                              ) {
                        ...
                        content = (0,
                        generaltranslation_1.splitStringToContent)(entry);
                        hash =
                          (metadata === null || metadata === void 0
                            ? void 0
                            : metadata.hash) ||
                          I18NConfig.hashContent(
                            content,
                            metadata === null || metadata === void 0
                              ? void 0
                              : metadata.context
                        ...
                        dictionary[entryId] = [
                          entry,
                          __assign(__assign({}, metadata), { hash: hash }),
                        ];
                        ...
                        if (!entry.length) {
                          translations[key] = {
                            state: 'error',
                            error:
                              'Empty strings are not allowed for translation.',
                            code: 400,
                          };
                          return [2 /*return*/];
                        }
        ...
        case 6:
          ...
          return [
            2 /*return*/,
            (0, jsx_runtime_1.jsx)(
              ClientProviderWrapper_1.default,
              __assign(
                {
