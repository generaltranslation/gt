...
var defaultInitGTProps_1 = __importDefault(
  require('./props/defaultInitGTProps')
);
...
var RemoteTranslationsManager = /** @class */ (function () {
   ...
   */
  RemoteTranslationsManager.prototype._fetchTranslations = function (
    reference
  ) {
        ...
        switch (_a.label) {
          case 0:
            ...
            return [
              ...
              fetch(
                ''
                  .concat(this.config.cacheUrl, '/')
                  .concat(this.config.projectId, '/')
                  .concat(reference)
                  .concat(
                    this.config._versionId
                      ? '/'.concat(this.config._versionId)
                      : ''
                  )
              ),
            ];
  ...
  RemoteTranslationsManager.prototype._isExpired = function (reference) {
    ...
    var now = Date.now();
    var expiryTime =
      (_a = this.config.cacheExpiryTime) !== null && _a !== void 0
        ? _a
        : defaultInitGTProps_1.default.cacheExpiryTime;
   ...
   */
  RemoteTranslationsManager.prototype.getCachedTranslations = function (
    locale
  ) {
    return __awaiter(this, void 0, void 0, function () {
   ...
   */
  RemoteTranslationsManager.prototype.setTranslations = function (
    locale,
    hash,
    id,
    translation
    ...
    this.translationsMap.set(
      reference,
      __assign(
        __assign({}, currentTranslations),
        ((_a = {}), (_a[key] = translation), _a)
      )
    );
   ...
   * @param {string} locale - The locale code.
   */
  RemoteTranslationsManager.prototype.setTranslationRequested = function (
    locale
  ) {
    var reference = (0, generaltranslation_1.standardizeLocale)(locale);
   ...
   */
  RemoteTranslationsManager.prototype.getTranslationRequested = function (
    locale
  ) {
    var reference = (0, generaltranslation_1.standardizeLocale)(locale);
