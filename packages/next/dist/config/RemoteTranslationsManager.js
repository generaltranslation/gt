...
var RemoteTranslationsManager = /** @class */ (function () {
    ...
    RemoteTranslationsManager.prototype._fetchTranslations = function (reference) {
        return __awaiter(this, void 0, void 0, function () {
            var sourceConfig, getTranslation, txSource, parsedResult, error_1, response, result, parsedResult, error_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 7, , 8]);
                        if (!this.config.srcDir) return [3 /*break*/, 4];
                        _a.label = 1;
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        console.log('attempting to fetch translations from source');
                        sourceConfig = require('gt-next/_source');
                        getTranslation = sourceConfig.default;
                        return [4 /*yield*/, getTranslation(reference)];
                    case 2:
                        txSource = _a.sent();
