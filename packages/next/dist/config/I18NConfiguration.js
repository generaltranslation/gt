...
var I18NConfiguration = /** @class */ (function () {
    function I18NConfiguration(_a) {
        ...
        // Dictionaries
        dictionary = _a.dictionary, srcDir = _a.srcDir, 
        // Batching config
        maxConcurrentRequests = _a.maxConcurrentRequests, maxBatchSize = _a.maxBatchSize, batchInterval = _a.batchInterval, 
        // Other metadata
        metadata = __rest(_a, ["runtimeTranslation", "remoteCache", "apiKey", "devApiKey", "projectId", "_versionId", "runtimeUrl", "cacheUrl", "cacheExpiryTime", "defaultLocale", "locales", "renderSettings", "dictionary", "srcDir", "maxConcurrentRequests", "maxBatchSize", "batchInterval"]);
        // Cloud integration
        this.apiKey = apiKey;
