...
function initGT(_a) {
    ...
    var config = _a.config, i18n = _a.i18n, dictionary = _a.dictionary, devApiKey = _a.devApiKey, runtimeTranslation = _a.runtimeTranslation, remoteCache = _a.remoteCache, apiKey = _a.apiKey, projectId = _a.projectId, runtimeUrl = _a.runtimeUrl, cacheUrl = _a.cacheUrl, cacheExpiryTime = _a.cacheExpiryTime, locales = _a.locales, defaultLocale = _a.defaultLocale, renderSettings = _a.renderSettings, maxConcurrentRequests = _a.maxConcurrentRequests, maxBatchSize = _a.maxBatchSize, batchInterval = _a.batchInterval, metadata = __rest(_a, ["config", "i18n", "dictionary", "devApiKey", "runtimeTranslation", "remoteCache", "apiKey", "projectId", "runtimeUrl", "cacheUrl", "cacheExpiryTime", "locales", "defaultLocale", "renderSettings", "maxConcurrentRequests", "maxBatchSize", "batchInterval"]);
