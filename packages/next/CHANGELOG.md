...
- f0fc1f7: Support `enableAutoJsxInjection` in the Next.js SWC plugin, including Turbopack. Automatically wrap translatable JSX before hash injection, matching the wrapping behavior of `@generaltranslation/compiler`.
