...
import { apiKeyInProductionError, APIKeyMissingWarn, projectIdMissingError, projectIdMissingWarning } from "../../errors/createErrors";
import { defaultCacheUrl, defaultRuntimeApiUrl } from "generaltranslation/internal";
...
export function useErrorChecks({
    devApiKey, 
    projectId, runtimeUrl, loadTranslationsType, cacheUrl, locales
}: {
    devApiKey?: string;
    projectId: string;
    runtimeUrl: string;
