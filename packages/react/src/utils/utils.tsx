...
export function readAuthFromEnv(
  ...
  try {
    return {
      projectId: projectId || import.meta.env.VITE_GT_PROJECT_ID || import.meta.env.REDWOOD_ENV_GT_PROJECT_ID ||'',
      devApiKey: devApiKey || import.meta.env.VITE_GT_API_KEY || import.meta.env.REDWOOD_ENV_GT_API_KEY,
    };
  } catch {}
  // everything else
  try {
