...
export declare function isEmptyReactFragment(target: unknown): target is React.ReactElement;
export declare function getAuth(projectId?: string, devApiKey?: string): {
    projectId?: string;
    devApiKey?: string;
};
