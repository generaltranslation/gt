 ...
 */
export declare function GTSelect({ children, ...props }: React.PropsWithChildren<React.JSX.IntrinsicElements['select']>): React.ReactElement;
/**
 * A dropdown component that allows users to select a locale.
 ...
 */
export declare function GTOption({ children, ...props }: React.PropsWithChildren<React.JSX.IntrinsicElements['option']>): React.ReactElement;
//# sourceMappingURL=GTLocaleDropdown.d.ts.map