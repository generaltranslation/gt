...
const flattenDictionary_1 = __importDefault(require("./internal/flattenDictionary"));
exports.flattenDictionary = flattenDictionary_1.default;
const addGTIdentifier_1 = __importDefault(require("./internal/addGTIdentifier"));
exports.addGTIdentifier = addGTIdentifier_1.default;
const writeChildrenAsObjects_1 = __importDefault(require("./internal/writeChildrenAsObjects"));
exports.writeChildrenAsObjects = writeChildrenAsObjects_1.default;
const getPluralBranch_1 = __importDefault(require("./branches/plurals/getPluralBranch"));
exports.getPluralBranch = getPluralBranch_1.default;
const getDictionaryEntry_1 = __importDefault(require("./provider/helpers/getDictionaryEntry"));
exports.getDictionaryEntry = getDictionaryEntry_1.default;
const extractEntryMetadata_1 = __importDefault(require("./provider/helpers/extractEntryMetadata"));
...
const isVariableObject_1 = __importDefault(require("./provider/helpers/isVariableObject"));
exports.isVariableObject = isVariableObject_1.default;
const getVariableName_1 = __importStar(require("./variables/getVariableName"));
...
const defaultRenderSettings_1 = require("./provider/rendering/defaultRenderSettings");
