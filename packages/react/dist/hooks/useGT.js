...
export default function useGT(id = '') {
    ...
    const { translateDictionaryEntry } = useGTContext(`useGT('${id}'): No context provided. You're trying to get the t() function on the client, which can only be done inside a <GTProvider>.`);
    /**
