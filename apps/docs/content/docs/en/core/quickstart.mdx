...
<Steps>
  <Step>
    ...
    Uploading files returns a list of file references with the [`uploadSourceFiles()`](/docs/core/class/methods/translation/uploadSourceFiles) method.
  ...
  <Step>
    ...
    The next step is to select the target locales for the translation with the [`enqueueFiles()`](/docs/core/class/methods/translation/enqueueFiles) method.
  ...
  <Step>
    ...
    We can use the [`checkFileTranslations()`](/docs/core/class/methods/translation/checkFileTranslations) method to check on the file status.
  ...
  <Step>
    ...
    Finally, we can download the translated file with the [`downloadTranslatedFile()`](/docs/core/class/methods/translation/downloadTranslatedFile) method.
