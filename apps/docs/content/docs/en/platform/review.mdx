...
1. Go to the [project review page](https://dash.generaltranslation.com/project/review-translations).
...
<Callout>
  ...
  Currently, file approval is not supported. Only Jsx approval is currently supported.
</Callout>