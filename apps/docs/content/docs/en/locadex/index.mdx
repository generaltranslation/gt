...
Locadex allows you to: 

- Focus on building your app, rather than internationalizing it
- Control your i18n workflow
- Seamlessly integrate i18n with your existing codebase
- Fully internationalize your app with a single command
- Create production-ready translations in seconds

### Developer-first control

With Locadex, you can also:
- Customize internationalized content with Dates, Numbers, Branches, and more
- Add your own custom translations to your app
- Get all of the features offered by the [gt-next i18n library](/docs/next)
- and more!
...
- Node.js 18+
- git 2.23+
- An App using Next.js App Router
