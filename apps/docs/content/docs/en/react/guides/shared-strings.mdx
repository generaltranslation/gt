...
This guide will walk you through how to easily internationalize shared strings in your React app using the [`msg()`](/docs/react/api/strings/msg) function & [`useMessages()`](/docs/react/api/dictionary/useMessages) hook.
 ...
 * See the [API reference for `useMessages()`](/docs/react/api/dictionary/useMessages).
