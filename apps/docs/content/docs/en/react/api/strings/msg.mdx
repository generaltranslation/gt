...
The encoded string should be passed to the [`useTranslations()`](/docs/react/api/dictionary/useTranslations) hook or [`getTranslations()`](/docs/react/api/dictionary/getTranslations) function to retrieve translations.
...
```jsx copy
import { msg, useTranslations } from 'gt-react';
...
## Next steps
 * See [`useTranslations()`](/docs/react/api/dictionary/useTranslations) for translating strings.
