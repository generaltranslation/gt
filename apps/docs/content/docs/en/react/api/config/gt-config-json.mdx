...
This file is read by (1) your [`withGTConfig()`](/docs/react/api/config/withGTConfig) component and (2) the [`gtx-cli translate`](/docs/cli/translate) command.
Because of this, we recommend storing your configuration in your `gt.config.json` file instead of passing it as a prop to your [`withGTConfig()`](/docs/react/api/config/withGTConfig) component.
 ...
 * It is read by both the [`withGTConfig()`](/docs/react/api/config/withGTConfig) component and the [`gtx-cli translate`](/docs/cli/translate) command.
 

## Next steps
 * Learn how to have your [translations added to your project's bundle](/docs/react/guides/local-tx).