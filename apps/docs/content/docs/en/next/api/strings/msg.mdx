...
The encoded string should be passed to the [`useTranslations()`](/docs/next/api/dictionary/useTranslations) hook or [`getTranslations()`](/docs/next/api/dictionary/getTranslations) function to retrieve translations.
...
## Next steps
 * See [`useTranslations()`](/docs/next/api/dictionary/useTranslations) for translating strings.
 * See [`getTranslations()`](/docs/next/api/dictionary/getTranslations) for translating strings in async server-side components.
