...
<TypeTable
    type={{
        ...
        "dynamicJsxCheckLogLevel?": {
            type: '"error" | "warn" | "off"',
            optional: true,
            default: '"warn"',
        },
        "dynamicStringCheckLogLevel?": {
            type: '"error" | "warn" | "off"',
            optional: true,
            default: '"warn"',
        },
...
This example configures the SWC plugin to treat dynamic content violations as build errors instead of warnings.
