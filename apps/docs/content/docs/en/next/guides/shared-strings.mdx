...
This guide will walk you through how to easily internationalize shared strings in your Next.js app using the [`msg()`](/docs/next/api/strings/msg) function & [`useMessages()`](/docs/next/api/dictionary/useMessages) hook.
 ...
 * See the [API reference for `useMessages()`](/docs/next/api/dictionary/useMessages).
