...
- `files`: This is an object that contains information about the content you want to translate. See the [files](/docs/cli/reference/config#files) section for more information.
