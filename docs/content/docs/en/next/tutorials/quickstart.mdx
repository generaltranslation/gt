...
- Learn how to improve SEO with [i18n routing](/docs/next/guides/middleware) (adding routes for each locale, e.g. `example.com/en`, `example.com/fr`) and [static site generation](/docs/next/guides/ssg).
