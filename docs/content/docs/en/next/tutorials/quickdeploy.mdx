...
We'll assume that you have already setup your Next.js app with GT. 
If you haven't, first setup your project by following the [Quick Start Guide](/docs/next/tutorials/quickstart), or the [manual setup guide](/docs/next/guides/setup).
