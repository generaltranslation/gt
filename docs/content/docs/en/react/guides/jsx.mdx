...
To get around this, try to use [Variable Components](/docs/react/guides/variables) or [Branching Components](/docs/react/guides/branches) to wrap the dynamic content.
