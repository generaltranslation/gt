...
description: How to translate JSX components
---

## Overview

This guide will walk you through how to use the [`<T>` component](/docs/react/api/components/t) to translate JSX content.
...
<Callout>
  In the above examples, the content can be safely translated using [variable components](/docs/react/guides/variables) and [branching components](/docs/react/guides/branches).
</Callout>
