...
var RemoteTranslationsManager = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        error_1 = _a.sent();
                        console.error(remoteTranslationsError, error_1);
                        return [3 /*break*/, 4];
    ...
    RemoteTranslationsManager.prototype._isExpired = function (reference) {
        ...
        if (!fetchTime)
            return true;
        var now = Date.now();
        var expiryTime = (_a = this.config.cacheExpiryTime) !== null && _a !== void 0 ? _a : defaultInitGTProps.cacheExpiryTime;
    ...
    RemoteTranslationsManager.prototype.getTranslations = function (locale) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        reference = standardizeLocale(locale);
    ...
    RemoteTranslationsManager.prototype.setTranslations = function (locale, key, id, translation) {
        ...
        if (!(locale && key && id && translation))
            return false;
        var reference = standardizeLocale(locale);
...
export { RemoteTranslationsManager };
