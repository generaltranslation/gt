 ...
 */
function Plural(_a) {
    var children = _a.children, n = _a.n, _b = _a.locales, locales = _b === void 0 ? [getI18NConfig().getDefaultLocale()] : _b, props = __rest(_a, ["children", "n", "locales"]);
    var generaltranslation = props["data-_gt"], branches = __rest(props, ['data-_gt']);
    var branch = (typeof n === 'number' ? getPluralBranch(n, locales, branches) : children) || children;
