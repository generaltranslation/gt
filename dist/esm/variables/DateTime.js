...
function DateTime(_a) {
    ...
    if (!value) {
        return (_jsx("span", { "data-_gt": generaltranslation, "data-_gt-variable-name": name, "data-_gt-variable-type": "date", "data-_gt-variable-options": options, style: { display: 'contents' } }));
    }
    ...
    var dateString = dateValue ? formatDateTime({ value: dateValue, locales: locales, options: options }) : '';
    var formattedValue = dateString.replace(/[\u200F\u202B\u202E]/g, '');
    // Render the formatted date within a span element
    return (_jsx("span", { "data-_gt": generaltranslation, "data-_gt-variable-name": name, "data-_gt-variable-type": "date", "data-_gt-variable-options": JSON.stringify(options), "data-_gt-unformatted-value": isValidDate(dateValue) ? dateValue : undefined, style: { display: 'contents' }, suppressHydrationWarning: true, children: formattedValue }));
}
;
