...
function Var(_a) {
    ...
    if (typeof children !== 'undefined' && typeof value === 'undefined')
        value = children;
    return (_jsx("span", { "data-_gt": generaltranslation, "data-_gt-variable-name": name, "data-_gt-variable-type": "variable", style: { display: 'contents' }, suppressHydrationWarning: true, children: value }));
}
;
