...
var createMismatchingHashWarning = function (expectedHash, receivedHash) { return "gt-next: Mismatching hashes! Expected hash: ".concat(expectedHash, ", but got hash: ").concat(receivedHash, ". We will still render your translation, but make sure to update to the newest version: www.generaltranslation.com/docs"); };
exports.createMismatchingHashWarning = createMismatchingHashWarning;
var createMismatchingIdHashWarning = function (expectedId, expectedHash, receivedId, receivedHash) { return "gt-next: Mismatching ids or hashes! Expected id: ".concat(expectedId, ", hash: ").concat(expectedHash, ", but got id: ").concat(receivedId, ", hash: ").concat(receivedHash, ". We will still render your translation, but make sure to update to the newest version: www.generaltranslation.com/docs"); };
