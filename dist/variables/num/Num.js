 ...
 */
function Num(_a) {
    var children = _a.children, _b = _a.name, name = _b === void 0 ? "n" : _b, value = _a.value, _c = _a.options, options = _c === void 0 ? {} : _c, _d = _a.locales, locales = _d === void 0 ? [(0, getI18NConfig_1.default)().getDefaultLocale()] : _d, props = __rest(_a, ["children", "name", "value", "options", "locales"]);
