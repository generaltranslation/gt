 ...
 *
 */
export declare function initGT({ i18n, dictionary, runtimeTranslation, remoteCache, apiKey, devApiKey, projectId, runtimeUrl, cacheUrl, cacheExpiryTime, locales, defaultLocale, renderSettings, maxConcurrentRequests, maxBatchSize, batchInterval, ...metadata }?: InitGTProps): (config?: any) => any;
