...
- Treat top-level `src/*.ts` and `src/*.tsx` files as package entrypoints only. Put components, hooks, providers, setup code, and other implementation logic under `src` subdirectories.
